...
const Register = () => {
    ...
    const {
        name, lastName, userName, email, password, repeatPassword,
        loading, error,
        handleNameChange, handleLastNameChange, handleUserNameChange,
        handleEmailChange, handlePasswordChange, handleRepeatPasswordChange,
        handleSubmit
    } = useRegister();
